...
public partial class FastbootDriver
{
    ...
    /// </summary>
    /// <param name="data">Data bytes to stage. <para>要暂存的数据字节。</param>
    ...
    /// </summary>
    /// <param name="stream">Stream containing data to stage. <para>包含要暂存数据的流。</param>
    /// <param name="length">Length of data in bytes. <para>数据字节长度。</param>
    /// <returns>A FastbootResponse indicating the result. <para>指示操作结果的 FastbootResponse。</para></returns>
    ...
    /// </summary>
    /// <param name="filePath">Path to the file to stage. <para>要暂存的文件路径。</param>
    /// <returns>A FastbootResponse indicating the result. <para>指示操作结果的 FastbootResponse。</para></returns>
