...
public partial class FastbootDriver
{
    ...
    /// </summary>
    /// <param name="kernelPath">Path to the kernel image file. <para>内核镜像文件路径。</param>
    ...
    /// <param name="headerVersion">Boot image header version (0-6). Default is 0. <para>启动镜像头版本（0-6）。默认为 0。</param>
