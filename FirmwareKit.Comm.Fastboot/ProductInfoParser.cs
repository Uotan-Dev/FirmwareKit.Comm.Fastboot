...
namespace FirmwareKit.Comm.Fastboot
{
    public class ProductInfoParser
    {
        ...
        public ProductInfoParser(FastbootUtil fastboot)
        {
            _fastboot = fastboot;
        }
        ...
        public bool Validate(string content, out string? error)
        {
            ...
            foreach (string rawLine in lines)
            {
                ...
                if (line.StartsWith("require "))
                {
                    ...
                    string[] requirements = contentPart.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
                ...
                else if (line.StartsWith("reject "))
                {
                    ...
                    string[] rejections = contentPart.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
